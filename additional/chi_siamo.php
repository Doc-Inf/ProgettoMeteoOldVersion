...
<body>
    ...
    <h2 class="benvenuto noiSiamo spazio">
    ...
    <div class="spazio sfondotrasparente">
        ...
        <hr>
        <h2 class="benvenuto" style="color:yellowgreen;">
        ...
        <br>
        <h2 class="benvenuto" style="color:khaki;">
        ...
        <br>
        <h2 class="benvenuto" style="color:#00000055; text-shadow: 0 0 #00000000;">
