...
CREATE TABLE `y2022` (
  ...
  windDir           VARCHAR(5) NOT NULL,
  windRun           DECIMAL(5,2),
  hiSpeed           DECIMAL(4,1),
  hiDir             VARCHAR(5),
  chillWind         DECIMAL(4,1),
  heatIndex         DECIMAL(4,1),
  thwIndex          DECIMAL(4,1),
  bar               DECIMAL(6,1) NOT NULL,
  rain              DECIMAL(4,1),
  rainRate          DECIMAL(5,1),
  heatDD            DECIMAL(4,3),
  coolDD            DECIMAL(4,3),
  inTemp            DECIMAL(4,1),
  inHum             INT,
  ...
  inHeat            DECIMAL(4,1),
  inEMC             DECIMAL(4,2),
  inAirDensity      DECIMAL(5,4),
  windSamp          INT,
  windTx            INT,
  issRecept         DECIMAL(4,1),
  arcInt            INT
);
...
INSERT INTO login(username, password,ruolo) value ("docente", '911cf6974b1c868afb38a0e9a223925bb7a346faaaa2c8d5b8a71d06b224c991','superadmin');
-- Vecchia password: INSERT INTO login(username, password,ruolo) value ("docente", '4a06fcaff060e92bcc38c5b5ecb2e599c6dc20dd92fcbe13f9fee62c2b735db9','superadmin');
...
INSERT INTO `y2022`(data, tempOut, bar, outHum, windDir, windSpeed) VALUES 
...
INSERT INTO `y2023`(data, tempOut, bar, outHum, windDir, windSpeed) VALUES     	
