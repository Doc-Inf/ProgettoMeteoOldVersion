...
<head>
    ...
    <meta name="parole chiave" content="Principale"/>    
    ...
    <div class="page" id="zona"> 
        <div class="pacchetto">
            <div class="info" id="infolarghezza1">
                ...
                <h3 class="bordo" id="umidità">Umidita: --%</h3>
    ...
    <script type="text/javascript" defer>
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                [giorniSet[conta[4]],         tempMer,      umiMer], //ciao io mi chiamo jponny!
